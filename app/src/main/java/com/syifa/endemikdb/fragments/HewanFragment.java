...
public class HewanFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        View view = inflater.inflate(
                R.layout.fragment_hewan,
                container,
                false
        );

        recyclerView = view.findViewById(R.id.rvHewan);
        ...
        List<Endemik> data = database.endemikDao().getHewanHome();
        ...
        chipGroupRegion.setOnCheckedStateChangeListener((group, checkedIds) -> {
            ...
            if (region.equals("Semua")) {
                loadRecycler(database.endemikDao().getHewanHome());
            } else {
                loadRecycler(database.endemikDao().getHewanByRegion(region));
            }
